...
UI = {
    ...
    "greeting_name": L("I'm Anthony Gozzini, a CRM & lifecycle marketer", "sono Anthony Gozzini, mi occupo di CRM e lifecycle marketing"),
...
HOME = {
    ...
    "intro": L(
        ...
        "Ho passato otto anni nella community di Trust Wallet, sette da volontario e poi nel team Marketing & Communications, e gli strumenti che mi servono li costruisco da solo.",
    ),

...
- Sep 2026: [Released Telegram Gatekeeper Bot v3.0.0](https://github.com/anthonygozzini/telegram-gatekeeper-bot/releases). The bot that screens people before they join a private group is now generic: any community sets its own questions in one config file.
- Sep 2026: [Rebuilt Sgamers, my first game](https://anthonygozzini.github.io/writing/rebuilding-sgamers/index.md). The original project was lost. I rebuilt it from the only surviving build and got it running again, in a browser too.
- Sep 2026: [Referral System v1.1.0 and Channel Copier v1.0.1](https://github.com/anthonygozzini/Telegram-Referral-System/releases). Two bots I first built for paying clients, cleaned up and released with proper versions.
- Sep 2026: [Published GuardBot and channel-miner](https://anthonygozzini.github.io/projects/index.md). A pre-trade safety checker for three blockchains, and a tool that turns a YouTube channel into searchable text.
- Aug 2026: Closed my chapter at Trust Wallet. Nearly a year and a half on the Marketing & Communications team, after seven years as a volunteer. Now looking for what's next.
- Apr 2025: Joined Trust Wallet's Marketing & Communications team. Hired to run CRM and lifecycle after seven years as a volunteer ambassador in the same community.

## Career

The short version of thirteen years in customer engagement and data; the full one is on LinkedIn. [LinkedIn profile](https://www.linkedin.com/in/anthonygozzini)

- Apr 2025 – Aug 2026: CRM & Lifecycle Marketing, Trust Wallet. CRM strategy, localization in ten languages, the crisis playbook and a Telegram network of 15+ communities.
- 2018 – Apr 2025: Community Ambassador, Trust Squad, Trust Wallet · volunteer. Coordinated thirty ambassadors and administered the global Telegram community.
- Apr 2017 – now: Web3 Freelancer, Bitgrail · The OGz Club · Affidaty · The Jungle Industry. Support and CRM, community campaigns, SEO and a weekly market column.
- Sep 2017 – Apr 2019: Customer Support Specialist, Motorola Solutions · Kraków. EMEA support on Salesforce; lead conversion up 14%.
- Mar – Aug 2017: Web Data Analyst for Google, Accenture · Kraków. Policy-compliance review at 98% accuracy.
- Jun 2013 – Feb 2017: Customer Business Support, Sabre Travel Network · Kraków. SAP billing and customer profiles; trained a team of twenty.

### Education

- Jan – Mar 2025: CS50: Introduction to Computer Science, Harvard Online. C, Python, SQL and the web.
- 2005 – 2011: Aeronautical technical diploma, Technical institute. Six years of aeronautical engineering.

## How I work

### Nothing ships unchecked

AI agents are fast and often wrong in convincing ways. Every output, from a translated push notification to a line of code, is untrusted until it has been verified.

### Size the problem first

Before proposing a campaign I look at where people actually drop out. At Trust Wallet that meant mapping the onboarding funnel before deciding who to message.

### I take the problems nobody owns

Four fragmented internal tools, a campaign calendar nobody kept, an incident with no playbook: I'd rather write the document that fixes it than wait for someone else to.

### Write it down

Playbooks, calendars and templates, so the next person, or the next incident, doesn't start from zero.
